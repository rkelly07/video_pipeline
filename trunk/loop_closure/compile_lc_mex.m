...
filesToCompile = {'mex_openfabmap.cpp'...
                  }; 
...
elseif ismac
    ...
    srcDep = cat(2,'-I/home/rosman/opencv-2.4.10.1-install/include/ -I/usr/include/eigen3 ',srcDep); 
end
...
elseif ismac
    ...
    lnkDepPath = cat(2,lnkDepPath, '-L/usr/local/cuda/lib64 -L/home/rosman/opencv-2.4.10.1-install/lib ');
end
