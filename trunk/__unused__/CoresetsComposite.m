classdef CoresetsComposite < handle
  ...
  properties (SetAccess = protected)
    ...
    times;
    keypoint_maps;
    coresets     % cell array of segments
  ...
  methods
    ...
    % constructor
    function this = CoresetsComposite()
...
%     end
    ...
    function plot(this,varargin)
      ...
      if legend_on
        for i = 1:this.d
          legend_str = cat(1,legend_str,['D' num2str(i)]);
        end
      end
      for i = 1:this.m
        C = this.segments{i}.coresets('SVDSegmentCoreset');
        C.plot(plot_style,'LineWidth',line_width,'Legend','off','Colormap',colormap_str)
        if legend_on && i == 1
          legend(legend_str)
        end
