...
video_filenames={'/home/rosman/Documents/MIT/video_analysis/trunk/data/video1.ogv','/home/rosman/Documents/MIT/video_analysis/trunk/data/video2.ogv','/home/rosman/Documents/MIT/video_analysis/trunk/data/video3.ogv','/home/rosman/Documents/MIT/data/TelepresenceRobot_Video.ogv','/home/rosman/Documents/MIT/data/Glass2.ogv'};
...
options.Plot=1;
%         for f_i=5:numel(video_filenames)
for f_i=1:5
    process_file_ocv(video_filenames{f_i},labindex,params,options,feature_coreset_alg,semantic_coreset_alg,coreset_params);
end
