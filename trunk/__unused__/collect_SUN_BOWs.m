function res=collect_SUN_BOWs(res,data_dir,num_workers,worker_id,max_image,descriptor_aggregators)
...
out_filename=[data_dir,filesep,'res_SUN_',num2str(num_workers),'_',num2str(worker_id),'.mat'];
